...
export default function Respiratory (){
    ...
    <div className="respiratory_container">
        ...
        <p className="para">
        At Lupin, we have been at the forefront of pioneering advancements in inhalation therapy. Our expertise in this field has led us to be one of the first companies to successfully genericize ProAir (Albuterol), a <Link href="https://www.lupin.com/US/product/albuterol-sulfate-inhalation-aerosol" className="hrefpara" >vital rescue medication for asthma and COPD patients</Link>, ensuring timely access to life-saving treatment. We also became the first to introduce a <Link href="https://www.lupin.com/US/product/tiotropium-bromide-inhalation-powder-capsules" className="hrefpara">generic version of Spiriva Handihaler (Tiotropium) </Link>, a dry powder inhaler used for long-term maintenance of COPD. 
        </p>
        <p className="para">
