...
<section data-section="generic_offer" className="generic_offer">
    <img src={imageUrl} alt={genericdata.image.alternativeText} className="generic_img" width={genericdata.image.width} height={genericdata.image.height} />
    <div className="generic_offer_container">
        ...
        <img src="/images/flower_bg.webp" alt="Big Flower" className="flower_offer" width="1500" height="1500" />
    </div>
</section>
    )
}